...
class BrowserLauncherAnnotationValidationTest {
  ...
  void annotation_shouldTargetTypeOnly() throws Exception {
    ...
    assertEquals(ElementType.TYPE, target.value()[0], "Annotation should target TYPE only");
  }
  ...
  void annotation_shouldHaveRequiredMethods() throws NoSuchMethodException {
    ...
    Method healthCheckEndpointMethod =
        BrowserLauncher.class.getDeclaredMethod("healthCheckEndpoint");
  ...
  void annotation_shouldHaveCorrectReturnTypes() throws NoSuchMethodException {
    ...
    assertEquals(String.class, valueMethod.getReturnType(), "value() should return String");
    assertEquals(String.class, urlMethod.getReturnType(), "url() should return String");
    assertEquals(String[].class, urlsMethod.getReturnType(), "urls() should return String[]");
    assertEquals(
        String.class,
        healthCheckEndpointMethod.getReturnType(),
        "healthCheckEndpoint() should return String");
    assertEquals(
        String[].class,
        excludeProfilesMethod.getReturnType(),
        "excludeProfiles() should return String[]");
    assertEquals(boolean.class, asyncMethod.getReturnType(), "async() should return boolean");
  }
  ...
  void annotation_shouldHaveCorrectDefaultValues() throws Exception {
    ...
    assertEquals("", valueMethod.getDefaultValue(), "value() should have empty string as default");
    assertEquals("", urlMethod.getDefaultValue(), "url() should have empty string as default");
    assertArrayEquals(
        new String[] {},
        (String[]) urlsMethod.getDefaultValue(),
        "urls() should have empty array as default");
    assertEquals(
        "",
        healthCheckEndpointMethod.getDefaultValue(),
        "healthCheckEndpoint() should have empty string as default");
    assertArrayEquals(
        new String[] {"docker", "test", "zimaos"},
        (String[]) excludeProfilesMethod.getDefaultValue(),
        "excludeProfiles() should have correct default values");
    assertEquals(false, asyncMethod.getDefaultValue(), "async() should have false as default");
  }
  ...
  void annotation_urlMethodShouldHaveEmptyStringDefault() throws NoSuchMethodException {
    Method urlMethod = BrowserLauncher.class.getDeclaredMethod("url");
    assertEquals(
        "", urlMethod.getDefaultValue(), "url() method should have empty string as default value");
  }
  ...
  void annotation_shouldBeApplicableToClasses() throws Exception {
    ...
    assertTrue(
        TestClassWithAnnotation.class.isAnnotationPresent(BrowserLauncher.class),
  ...
  void annotation_shouldNotBeApplicableToMethods() throws Exception {
    ...
    for (ElementType elementType : target.value()) {
      assertNotEquals(ElementType.METHOD, elementType, "Annotation should not target methods");
    }
  }
  ...
  void annotation_shouldNotBeApplicableToFields() throws Exception {
    ...
    for (ElementType elementType : target.value()) {
      assertNotEquals(ElementType.FIELD, elementType, "Annotation should not target fields");
    }
  }
  ...
  void annotation_shouldAllowMultipleProfilesInExcludeProfiles() throws Exception {
    BrowserLauncher annotation =
        TestClassWithMultipleProfiles.class.getAnnotation(BrowserLauncher.class);
  ...
  void annotation_shouldAllowEmptyExcludeProfiles() throws Exception {
    BrowserLauncher annotation =
        TestClassWithEmptyProfiles.class.getAnnotation(BrowserLauncher.class);
