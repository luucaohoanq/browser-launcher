...
class BrowserLauncherAnnotationTest {
  ...
  void annotation_shouldHaveCorrectDefaultValues() throws Exception {
    ...
    BrowserLauncher annotation =
        TestClassWithMinimalAnnotation.class.getAnnotation(BrowserLauncher.class);
  ...
  void annotation_shouldAllowCustomValues() throws Exception {
    BrowserLauncher annotation =
        TestClassWithCustomAnnotation.class.getAnnotation(BrowserLauncher.class);
  ...
  void annotation_shouldSupportValueParameter() throws Exception {
    BrowserLauncher annotation =
        TestClassWithValueParameter.class.getAnnotation(BrowserLauncher.class);
  ...
  void annotation_shouldSupportUrlsParameter() throws Exception {
    BrowserLauncher annotation =
        TestClassWithUrlsParameter.class.getAnnotation(BrowserLauncher.class);

    assertNotNull(annotation);
    assertEquals("", annotation.value());
    assertEquals("", annotation.url());
    assertArrayEquals(
        new String[] {"https://url1.com", "https://url2.com", "https://url3.com"},
        annotation.urls());
  }
  ...
  void annotation_shouldSupportEmptyExcludeProfiles() throws Exception {
    BrowserLauncher annotation =
        TestClassWithEmptyExcludes.class.getAnnotation(BrowserLauncher.class);
